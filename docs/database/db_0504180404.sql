...
--
-- Host: localhost:3306
-- Generation Time: 05-Abr-2018 às 07:04
...
(13, 19, 'created new project aaaa', 'Project Management', '2018-04-05 06:32:53');
...
(20, 'rodrigo.blizzard92@gmail.com', '51ef8f85e7be00232ebcde36c829a8af', 'Rodrigo de Oliveira Machado', 'user', 1, 'Unipampa', '', '2018-04-04 22:58:28', '2018-04-05 06:45:38');
...
--
ALTER TABLE `project_has_user`
  ADD CONSTRAINT `project` FOREIGN KEY (`project_id`) REFERENCES `project` (`project_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
